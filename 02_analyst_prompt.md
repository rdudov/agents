...
3. **Каталог артефактов пайплайна (`artifacts_dir`)** — путь, куда сохраняются все markdown-артефакты процесса
...
Изучи постановку задачи и проект, задай вопросы, создай ТЗ.
